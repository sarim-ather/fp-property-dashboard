...
export default function Modal({ title, onClose, children, wide = false }: ModalProps) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 animate-fade-in">
      ...
      <div className={`relative bg-white rounded-lg shadow-2xl border border-bone flex flex-col max-h-[90vh] animate-scale-in ${wide ? 'w-full max-w-3xl' : 'w-full max-w-lg'}`}>
